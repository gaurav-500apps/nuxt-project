    ...
    <div class="bg-white rounded-md shadow-md overflow-hidden">
      ...
      <div class="p-6">
        <p class="text-gray-700 mb-4">
          Welcome to our products website! We are passionate about delivering
          high-quality products and services. Our mission is to provide unique
        ...
        <div class="mb-4">
          <img
            src="https://as2.ftcdn.net/v2/jpg/04/51/35/83/1000_F_451358339_uRB7YqTP7GycLUSbbAJjOIh7G8KElvaU.jpg"
        ...
        <p class="text-gray-700">
          ...
          <router-link to="/contact" class="text-blue-500 underline"
            >contact us</router-link
          >. We value your input and look forward to serving you!
        </p>
      </div>
    </div>
  </div>
